            ...
            <form onSubmit={sendEmail}>
              <Grid container spacing={5}>
                <Grid item xs={12} md={6}>
                  ...
                  <TextField required  sx={{ width: '100%', backgroundColor: '#fff' }} name="name" id="outlined-basic" variant="outlined" />
                </Grid>
                <Grid item xs={12} md={6}>
                  <Typography variant="body2">PHONE NUMBER </Typography>
                  <TextField required id="outlined-basic" sx={{ width: '100%', backgroundColor: '#fff' }} name="phone" variant="outlined" />
                </Grid>
              </Grid>
              <Typography variant="body2" sx={{ pt: 3 }}>EMAIL</Typography>
              <TextField required id="outlined-basic" sx={{ width: '100%', mb: 3, backgroundColor: '#fff' }} name="email" variant="outlined" />
              <Typography variant="body2">SUBJECT</Typography>
              <TextField required id="outlined-basic" sx={{ width: '100%', mb: 3, backgroundColor: '#fff' }} name="subject" variant="outlined" />
